...
func (s *AuctionSystemSuite) TestCloseAuction() {
	...
	expectedCloseAuctionOutput := fmt.Sprintf(`auction closed - {"id":1,"token":"%s","creator":"%s","collateral_address":"%s","collateral_amount":"10000","debt_issued":"100000","max_interest_rate":"10","total_obligation":"108195","state":"closed","orders":[`+
	...
	expectedFindAuctionByCreatorOutput := fmt.Sprintf(`[{"id":1,"token":"%s","creator":"%s","collateral_address":"%s","collateral_amount":"10000","debt_issued":"100000","max_interest_rate":"10","total_obligation":"108195","state":"closed","orders":[`+
		`{"id":1,"auction_id":1,"investor":"%s","amount":"59500","interest_rate":"9","state":"partially_accepted","created_at":%d,"updated_at":%d},`+
		`{"id":2,"auction_id":1,"investor":"%s","amount":"28000","interest_rate":"8","state":"accepted","created_at":%d,"updated_at":%d},`+
		`{"id":3,"auction_id":1,"investor":"%s","amount":"2000","interest_rate":"4","state":"accepted","created_at":%d,"updated_at":%d},`+
		`{"id":4,"auction_id":1,"investor":"%s","amount":"5000","interest_rate":"6","state":"accepted","created_at":%d,"updated_at":%d},`+
...
func (s *AuctionSystemSuite) TestSettleAuction() {
	...
	expectedSettleAuctionOutput := fmt.Sprintf(`auction settled - {"id":1,"token":"%s","creator":"%s","collateral_address":"%s","collateral_amount":"10000","debt_issued":"100000","max_interest_rate":"10","total_obligation":"108195","state":"settled","orders":[`+
...
func (s *AuctionSystemSuite) TestExecuteAuctionCollateral() {
	...
	expectedExecuteAuctionCollateralOutput := fmt.Sprintf(`auction collateral executed - {"auction_id":1,"token":"%s","creator":"%s","collateral_address":"%s","collateral_amount":"10000","debt_issued":"100000","max_interest_rate":"10","total_obligation":"108195","state":"collateral_executed","orders":[`+
...
func (s *AuctionSystemSuite) TestFindAllAuctions() {
	...
	expectedFindAllAuctionsOutput := fmt.Sprintf(`[{"id":1,"token":"0x0000000000000000000000000000000000000009","creator":"0x0000000000000000000000000000000000000007","collateral_address":"0x0000000000000000000000000000000000000008","collateral_amount":"10000","debt_issued":"100000","max_interest_rate":"10","total_obligation":"0","state":"ongoing","orders":[],"created_at":%d,"closes_at":%d,"maturity_at":%d,"updated_at":0}]`, baseTime, closesAt, maturityAt)
...
// 	collateral := common.HexToAddress("0x0000000000000000000000000000000000000008")
// 	token := common.HexToAddress("0x0000000000000000000000000000000000000009")
// 	// investor := common.HexToAddress("0x0000000000000000000000000000000000000010")
...
// 	expectedCreateAuctionOutput := fmt.Sprintf(`auction created - {"id":1,"token":"0x0000000000000000000000000000000000000009","creator":"0x0000000000000000000000000000000000000007","collateral_address":"0x0000000000000000000000000000000000000008","collateral_amount":"10000","debt_issued":"100000","max_interest_rate":"10","orders":null,"state":"ongoing","created_at":%d,"closes_at":%d,"maturity_at":%d}`, baseTime, closesAt, maturityAt)
// 	s.Equal(expectedCreateAuctionOutput, string(createAuctionResult.Notices[0].Payload))

// 	// findAuctionsByInvestorInput := []byte(fmt.Sprintf(`{"path":"auction/investor", "data":{"investor":"%s"}}`, investor))

// 	// findAuctionsByInvestorResult := s.tester.Inspect(findAuctionsByInvestorInput)
// 	// s.Len(findAuctionsByInvestorResult.Notices, 1)

// 	// expectedFindAuctionsByInvestorOutput := fmt.Sprintf(`[{"id":1,"token":"0x0000000000000000000000000000000000000009","creator":"0x0000000000000000000000000000000000000007","collateral_address":"0x0000000000000000000000000000000000000008","collateral_amount":"10000","debt_issued":"100000","max_interest_rate":"10","total_obligation":"50000","orders":[{"id":1,"auction_id":1,"investor":"0x0000000000000000000000000000000000000010","amount":"50000","interest_rate":"5","state":"pending","created_at":%d,"updated_at":0}],"state":"ongoing","created_at":%d,"closes_at":%d,"maturity_at":%d,"updated_at":0}]`, baseTime, baseTime, closesAt, maturityAt)
// 	// s.Equal(expectedFindAuctionsByInvestorOutput, string(findAuctionsByInvestorResult.Notices[0].Payload))
// }
